...
const HomePage: React.FC<HomePageProps> = ({ profileImageSrc = "https://ibb.co/yBgv1tPM", name = "Syed shouib Ali", description = "I'm Enthusiastic developer focused on creating intelligent and dynamic web applications. Currently diving into the world of AI agent development, I'm learning to build systems that drive innovation and automation." }) => {
  return (
